...
const PROJECTS = [
  { name:"Car Events Near Me", tag:"Directory", g:"linear-gradient(135deg,#123a6b,#0a1a33)",
    desc:"Next.js listings site for UK car events — filter by region, date and price, then go straight to the organiser's own booking page. No payments taken on site.",
  ...
  { name:"Prime Origins Atlas", tag:"Marketplace", g:"linear-gradient(135deg,#0e4d39,#06231a)",
    desc:"Carbon-credit marketplace. Browse by registry & vintage, buy with Stripe Checkout, 4% platform fee.",
  ...
  { name:"Prime Origins Global", tag:"Brand site", g:"linear-gradient(135deg,#14463a,#08231c)",
    desc:"Multi-page brand and product site for Prime Origins — range pages, provenance and the cultivation story.",
  ...
  { name:"Man With A Whistle", tag:"Business site", g:"linear-gradient(135deg,#4a3a14,#231b08)",
    desc:"Clean marketing site for a bespoke dog trainer — service pages with one-tap call, WhatsApp and email enquiry.",
  ...
  { name:"Parish in a Box", tag:"Platform", g:"linear-gradient(135deg,#4a1f3a,#220e1a)",
    desc:"Websites for England's parish and town councils. Transparency Code publishing, accessibility checks and Assertion 10 evidence packs.",
